  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        ...
        const res = await fetch(`${API_BASE}/dashboard/appointments/all/?${query.toString()}`, {
  ...
  return (
    <div>
      <div style={{ marginBottom: "2rem" }}>
        <h1 style={{ fontSize: "1.75rem", marginBottom: "0.5rem" }}>All Appointments</h1>
        <p style={{ color: "var(--text-secondary)" }}>View your entire appointment history.</p>
      </div>
