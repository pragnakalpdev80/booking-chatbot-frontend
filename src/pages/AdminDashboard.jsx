      ...
      try {
        if (activeTab === "settings") {
          ...
          if (res.status === 503 || res.status === 500) {
            throw new Error(
              "Google Calendar is not linked or an error occurred. Please link your calendar first."
            );
          }
              ...
              <div className="events-list">
                {events.map((ev, idx) => (
                  <div key={idx} className="event-card">
                    ...
                    <p>
                      <strong>End:</strong> {new Date(ev.end.dateTime).toLocaleString()}
                    </p>
                    {ev.description && (
                      <p>
                        <strong>Reason:</strong> {ev.description}
                      </p>
                    )}
